...
interface NPCEngine {
     ...
     */
    fun receiveEvent(event: AbstractEvent, newMood: Mood, newThoughtOnPlayer: CommonThought)
    /**
     ...
     */
    fun addDetails(name: String, detail: Map<String, Any>, comments: Map<String, String>)
}